  ...
  return (
    <div>
      <div className="px-[16%] mt-[65px]">
        ...
        <div className="w-full h-[200px] mt-3 flex flex-col justify-center items-center mb-20">
          <div className="text-center ">
            ...
            <div className="w-[200px] font-light">
...
export default HostngReservations;
