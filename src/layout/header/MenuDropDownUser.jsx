  ...
  return (
    ...
    >
      <div className="border rounded-full flex flex-row w-auto py-2 px-4 shadow cursor-pointer">
        <MenuButton className="flex flex-row items-center justify-between rounded-full w-12 h-6">
      ...
      >
        <MenuItem className="absolute right-0 z-10 mt-2 w-56 origin-top-right divide-y divide-gray-100 rounded-md bg-white shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none">
          <div className="py-1">
            <MenuItem>
              {({ isActive }) => (
                <Link
