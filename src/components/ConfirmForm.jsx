    ...
    <form>
      ...
      <div className="w-[34rem] pt-8 pb-6">
        <div className="flex justify-between mb-3">
          ...
          >
            <span className="font-bold text-[1.4rem]">Pay with</span>
          </label>
      ...
      <div className="my-8 h-[3.5rem] w-[12.75rem] bg-[#FF385C] flex justify-center items-center rounded-lg ">
        <span className="text-center text-white">Confirm and pay</span>
      </div>
    </form>
  );
}
